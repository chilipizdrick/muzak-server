      ...
      devShells.x86_64-linux.default = mkShell {
        ...
        shellHook = ''
          ...
          if [ ! -d ./temp/database ]; then
            ...
            initdb -D ./temp/database && sleep 2
            pg_ctl stop
